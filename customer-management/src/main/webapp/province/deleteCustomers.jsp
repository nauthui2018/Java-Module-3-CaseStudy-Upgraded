                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="provinces?action=deleteCustomersAndDeleteProvince" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <input value="${province.getProvinceID()}" type="hidden" name="provinceID" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-12 col-md-12" align="center">
                                                <span style="color: darkorange">Are you sure to delete this province and all customers?</span>
                                            </div>
                                            <div class="col-12 col-md-12 mt-3" align="center">
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm ml-2" style="width: 90px; color: black">
