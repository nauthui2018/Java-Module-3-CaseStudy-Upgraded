                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="ranks?action=deleteCustomersAndDeleteRank" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <input value="${rank.getRankID()}" type="hidden" name="rankID" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-12 col-md-12" align="center">
                                                <span style="color: darkorange">Are you sure to delete this rank and all customers?</span>
                                            </div>
