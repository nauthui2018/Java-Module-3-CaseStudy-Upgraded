                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="ranks?action=updateCustomersAndDeleteRank" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col-12 col-md-12">
                                            <span style="color: darkorange">Please select new rank for customers. List of customers showed as below!</span>
                                            <input value="${rank.getRankID()}" type="hidden" name="currentRankID" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Current Rank</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input value="${rank.getRankName()}" disabled type="text" name="rankName" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">New Rank</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <select name="newRankID" id="rankID" class="form-control">
