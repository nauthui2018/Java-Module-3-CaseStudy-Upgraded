                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <input value="${customer.getCustomerID()}" type="hidden" name="customerID" required="required" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input value="${customer.getFirstName()}" type="text" id="text-input" name="firstName" placeholder="First Name" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.getLastName()}" type="text" id="text-input" name="lastName" placeholder="Last Name" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.getDob()}" type="date" id="date-input" name="dob" placeholder="DOB" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.getAddress()}" type="text" id="text-input" name="address" placeholder="Address" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.getEmail()}" type="email" id="email-input" name="email" placeholder="Email" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.getTotalOrders()}" type="number" id="text-input" name="totalOrders" placeholder="Total Orders" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input  value="${customer.getTotalAmounts()}" type="number" id="text-input" name="totalAmounts" placeholder="Total Amounts" class="form-control">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="rankID" id="rankID" class="form-control">
                                                    <c:forEach items="${listRank}" var="item">
                                                        ...
                                                        <c:if test="${!(item.rankID==customer.getRankID())}">
                                                            <option value="${item.rankID}">${item.rankName}</option>
                                                        </c:if>
                                                    </c:forEach>
                                                </select>
