                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col-12 col-md-12">
                                                <span style="color: darkorange">Please select action for related customers</span>
                                            </div>
                                            <input value="${province.getProvinceID()}" type="hidden" name="provinceID" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Province Name</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input value="${province.getProvinceName()}" disabled type="text" name="provinceName" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="actionCode" class="form-control">
                                                    <option value="0" selected>-- Please select --</option>
                                                    <option value="1">Update new province</option>
                                                    <option value="2">Delete all customers</option>
                                                </select>
                                                <c:if test='${requestScope["message"] != null}'>
                                                    <label class="mt-3" style="color:red; font-size: smaller">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                <a type="cancel" class="btn btn-warning btn-sm" href="/provinces">
                                                    <i class="fa fa-window-close mr-1"></i>Cancel</a>
                                                <button type="submit" class="btn btn-primary btn-sm" style="width: 90px; color: black">
                                                    <i class="fas fa-check mr-1"></i>OK</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
