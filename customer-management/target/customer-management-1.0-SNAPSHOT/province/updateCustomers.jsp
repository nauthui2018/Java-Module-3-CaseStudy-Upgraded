                        ...
                        <div class="col-sm-12">
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/provinces">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="provinces?action=updateCustomersAndDeleteProvince" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col-12 col-md-12">
                                            <span style="color: darkorange">Please select new province for customers. List of customers showed as below!</span>
                                            <input value="${province.getProvinceID()}" type="hidden" name="currentProvinceID" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Current Province</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input value="${province.getProvinceName()}" disabled type="text" name="currentProvinceName" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">New Province</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <select name="newProvinceID" id="provinceID" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                <a type="cancel" class="btn btn-warning btn-sm"
                                                   href="#" onclick="window.history.back()" style="width: 90px">
                                                    <i class="fa fa-undo mr-1"></i>Back</a>
                                                <button type="submit" class="btn btn-primary btn-sm" style="width: 90px; color: black">
                                                    <i class="fas fa-check mr-1"></i>Confirm</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <table class="table table-borderless table-data3 mydatatable">
                                    ...
                                    <c:forEach var="customer" items="${listCustomer}">
                                        <tr>
                                            ...
                                            <td><c:out value="${customer.totalOrders}"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
