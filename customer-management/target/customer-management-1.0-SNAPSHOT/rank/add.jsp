                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Rank Name</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="rankName" placeholder="Rank Name" value="${requestScope["rankName"]}" class="form-control">
                                                <label>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                <a type="reset" class="btn btn-warning btn-sm" href="/ranks?action=add" style="width: 90px">
