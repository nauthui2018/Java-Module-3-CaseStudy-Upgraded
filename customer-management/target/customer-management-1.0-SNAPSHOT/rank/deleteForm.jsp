                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <input value="${rank.getRankID()}" type="hidden" name="rankID" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class="form-control-label">Rank Name</label>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="actionCode" class="form-control">
                                                    ...
                                                    <option value="1">Update new rank</option>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12"  align="right">
                                                <a type="cancel" class="btn btn-warning btn-sm" href="${pageContext.request.contextPath}/ranks">
